...
const Auth = () => {
  ...
  return (
    <main
      className={
        "bg-[url('/images/bg-auth.svg')] bg-cover min-h-screen flex flex-col gap-8 "
      }
    >
      ...
      <section className="flex flex-col items-center justify-center gap-8 bg-white rounded-2xl pt-20 pb-10">
        ...
        >
          ...
          <Link to={"https://puter.com"} className={"text-blue-700"}>
            puter.con
          </Link>
        </div>
      </section>
